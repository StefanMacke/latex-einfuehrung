...
% Mit \label wird ein referenzierbarer Punkt im Dokument festgelegt, der über
% seinen Namen angesprochen werden kann. Der Name ist Freitext, das "sec:" dient
% nur der besseren Auffindbarkeit.
\label{sec:Eltern}
...
% Die Verweise im Text können nun mit \ref oder \pageref erstellt werden.
...
% Für häufig verwendete Verweise kann man sich sprechende Befehle definieren.
